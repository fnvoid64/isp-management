                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p>
                                <a href="{{ route('invoices') }}?customer={{ $customer->id }}">
                                    <button class="btn btn-primary btn-block">View Invoices</button>
                                </a>
                            </p>
                            <p>
                                <a href="{{ route('payments') }}?customer={{ $customer->id }}">
            ...
            methods: {
                changeStatus(newStatus) {
                    ...
                    axios.post('{{ route('customers.changeStatus', ['customer' => $customer->id]) }}', {
                        ...
                        showAlertMsg('Customer status changed!');
                    }).catch(function (error) {
                        //console.log(error);
                        showAlertMsg('Cannot change customer status', 'error');
                        this.pageLoading = false;
                    });
                }
            }
