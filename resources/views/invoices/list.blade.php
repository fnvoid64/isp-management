                            ...
                            <table class="table table-striped">
                                ...
                                <tr v-for="item in items.data" :key="item.id">
                                    ...
                                    <td>
                                        ...
                                        <span class="badge badge-primary" v-if="item.status == {{ \App\Models\Invoice::STATUS_PARTIAL_PAID }}">Partially Paid</span>
                                        <span class="badge badge-danger" v-if="item.status == {{ \App\Models\Invoice::STATUS_UNPAID }}">Unpaid</span>
