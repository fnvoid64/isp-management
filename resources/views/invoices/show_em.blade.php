        ...
        <div class="col">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('employee_invoices') }}">Invoices</a></li>
                            ...
                            <div class="details-box">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detail-value">
                                        <a href="{{ route('employee_customers.show', ['customer' => $invoice->customer->id]) }}">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detail-value">
                                        @foreach(\App\Models\Employee::getEmployee()->user->packages()->whereIn('id', explode(',', $invoice->package_ids))->get() as $package)
    ...
    <div class="modal fade" id="payment" tabindex="-1" role="dialog" aria-labelledby="payment" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('employee_invoices.pay', ['invoice' => $invoice->id]) }}">
                    @csrf
